...
//  Serial.println();
  ...
  Serial.println("Question 1: Eden est éléve de SupGalilée ?");
  Serial.println("Question 2: Sommes nous en 2022 ? ");
  Serial.println("Question 3: Le projet est-il bien fait ?");
  //Serial.println("**************************************************************************** \n");
  Serial.println("\n\t\t\t\t ************ REPONSE_QUIZ ************ \n");
